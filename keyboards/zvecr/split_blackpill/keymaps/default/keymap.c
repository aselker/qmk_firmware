...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_5x6(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, KC_LCTL, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_J, KC_BSLS, KC_QUOT, KC_X, KC_S, KC_D, KC_F, KC_G, KC_H, KC_P, KC_K, KC_L, KC_SCLN, KC_LBRC, KC_LSFT, KC_Z, KC_A, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RBRC, KC_LCTL, KC_LGUI, KC_RGUI, KC_RCTL, KC_BSPC, KC_ENT, KC_SPC, KC_RSFT, MO(1), MO(2), MO(2), MO(1), KC_LALT, SH_MON, KC_ESC, KC_RALT),
	...
	[2] = LAYOUT_5x6(S(KC_ESC), S(KC_F1), S(KC_F2), S(KC_F3), S(KC_F4), S(KC_F5), S(KC_F6), S(KC_F7), S(KC_F8), S(KC_F9), S(KC_F10), S(KC_F11), KC_TRNS, S(KC_VOLU), KC_TRNS, KC_PGUP, KC_QUES, KC_PIPE, KC_LCBR, KC_RCBR, KC_UNDS, KC_PLUS, S(KC_INS), S(KC_F12), KC_TRNS, S(KC_VOLD), KC_HOME, KC_PGDN, KC_END, S(KC_TAB), KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_BRIGHTNESS_UP, RESET, KC_TRNS, S(KC_MUTE), KC_ESC, KC_COLN, KC_UNDS, KC_PLUS, KC_LPRN, KC_RPRN, KC_DQUO, KC_TRNS, KC_BRIGHTNESS_DOWN, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, S(KC_DEL), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
